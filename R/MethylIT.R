...
#'     detection theory and machine-learning. Methylation changes are expressed
#'     in terms of information divergence (ID) of methylation level. Methylation
...
#'     background noise (plus signal), which is used as null distribution for
#'     the application of basic signal detection theory.
#'
NULL
